...
A: First I'll create variables that contain the arrays

Q: How are you going to do it? 

A: By declaring variables with unique names that can be called easily

Q: Why are you going to do it? 

A: So that the data is accessible

Step Two: 

Q: What are you going to do? 

A: I am going to declare a function called addSum

Q: How are you going to do it? 

A: By writing function followed by the name

Q: Why are you going to do it? 

A: Because I need a function that can repeat itself for each array

Step Three: 

Q: What are you going to do? 

A: Declare a for loop

Q: How are you going to do it? 

A: By writing for followed by my arguments

Q: Why are you going to do it? 

A: To loop through a given array and find the sum
...
A: I'm going to create variables with the arrays inside of them

Q: How are you going to do it? 

A: By declaring variables with the data

Q: Why are you going to do it? 

A: So the data is easily accessible

Step Two: 

Q: What are you going to do? 

A: Use the previous function called calculateSum to add the numbers in the arrays

Q: How are you going to do it? 

A: By using the function calculateSum

Q: Why are you going to do it? 

A: So that the numbers can be added

Step Three: 

Q: What are you going to do? 

A: Divide the sum by the number array items

Q: How are you going to do it? 

A: By dividing the sum by the array.length

Q: Why are you going to do it? 

A: To determine the mean of the numbers
